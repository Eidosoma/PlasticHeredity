...
The exposed engineering rounds have frozen these final test objects: global-walsh-anchor, local-affine-p1-d20-w08-r100, local-affine-p2-d20-w08-r100. One is the old nonlocal broadcast used as a safety check; the others are spatially local. A one-site carrier still inherits only 64 bits, although the daughter temporarily grows a much larger working field while it develops.
