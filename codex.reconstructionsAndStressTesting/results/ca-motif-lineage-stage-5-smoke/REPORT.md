...
Screen-selected objects: 4.
Strictly qualified objects: 4.
Frozen confirmation objects: global-walsh-anchor, local-affine-p1-d10-w08-r100, local-affine-p2-d20-w08-r100.
Confirmation state: `awaiting_human_review`.

## Frozen objects

| Object | Scope | Inherited bits | Developmental working bits | Qualification |
|---|---|---:|---:|---:|
| `global-walsh-anchor` | global diagnostic | 64 | 0 | False |
| `local-affine-p1-d10-w08-r100` | 1x1 local patch | 64 | 131072 | False |
| `local-affine-p2-d20-w08-r100` | 2x2 local patch | 256 | 131072 | False |
