...
The exposed engineering rounds have frozen these final test objects: global-walsh-anchor. One is the old nonlocal broadcast used as a safety check; the others are spatially local. A one-site carrier still inherits only 64 bits, although the daughter temporarily grows a much larger working field while it develops.
