...
| Artifacts written | 27 required paths under `/artifacts/research_steps/S14`: report, 15 machine-readable result tables, four figures, method/input/provenance/validation/status/failure manifests, and artifact manifest |
...
- Repository: `https://github.com/Eidosoma/arrival-of-self-replicators.git` on `eidosoma/groups/42` at `665d063057d9fa4e4922a03615193440e3091205`.
