...
qa_dir="${project_dir}/tmp/pdfs/biorxiv-v2"
pdf_path="${output_dir}/plastic-heredity-biorxiv-v2-preview.pdf"
...
pandoc \
  --defaults paper_assets/biorxiv_pdf_v2.yaml \
  PRE_PRINT_PAPER_DRAFT_V2.md \
  --output "${pdf_path}"
